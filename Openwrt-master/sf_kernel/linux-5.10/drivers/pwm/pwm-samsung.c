...
static const struct samsung_pwm_variant siflower_variant = {
	.bits		= 16,
	.div_base	= 1,
	.has_tint_cstat	= true,
	.tclk_mask	= 0,
...
static const struct of_device_id samsung_pwm_matches[] = {
	...
	{ .compatible = "siflower,sf21a6826-pwm", .data = &siflower_variant },
	{},
};
...
static int pwm_samsung_probe(struct platform_device *pdev)
{
	...
	chip->rstc = devm_reset_control_get_optional_shared(&pdev->dev, NULL);
	if (IS_ERR(chip->rstc))
