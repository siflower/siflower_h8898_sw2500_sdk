#include <dt-bindings/clock/sf21h8898-clk.h>
...
static unsigned long PLL_FREQ[] = {2400000000, 3200000000, 10000000000, 10000000000};
static int PCIE_PLL_DEF_COF[] = { 4, 4, 4, 3, 4, 0 };
static int PLL_STAT[] = { 0, 0, 0, 0 };

static int div_range[4][4] = {
	{16, 320, 63, 7},
	{32, 1000, 63, 7},
	{32, 1000, 63, 8},
	{32, 1000, 63, 8}};
...
static sf_clk_data_t sf21h8898_clk_data = {
	.lock = &cm_cfg_lock,
	.clk_flags = CLK_GET_RATE_NOCACHE,
};
static sf_clk_data_t sf21h8898_clk_data_on = {
	.lock = &cm_cfg_lock,
	.clk_flags = CLK_GET_RATE_NOCACHE | CLK_IGNORE_UNUSED,
};
static sf_clk_data_t sf21h8898_clk_data_cpu = {
	.lock = &cm_cfg_lock_cpu,
	.clk_flags = CLK_SET_RATE_NO_REPARENT | CLK_GET_RATE_NOCACHE | CLK_IGNORE_UNUSED,
};
static sf_clk_data_t sf21h8898_clk_data_realcpu = {
	.lock = &cm_cfg_lock,
	.clk_flags = CLK_GET_RATE_NOCACHE | CLK_IGNORE_UNUSED | CLK_SET_RATE_PARENT,
};
static sf_clk_data_t sf21h8898_pll_data_ddr = {
	.lock = &cm_pll_lock_ddr,
	.clk_flags = CLK_SET_RATE_NO_REPARENT | CLK_IGNORE_UNUSED,
};
static sf_clk_data_t sf21h8898_pll_data_eth = {
	.lock = &cm_pll_lock_eth,
	.clk_flags = CLK_SET_RATE_NO_REPARENT | CLK_GET_RATE_NOCACHE | CLK_SET_RATE_GATE,
};
static sf_clk_data_t sf21h8898_pll_data_pcie = {
	.lock = &cm_pll_lock_pcie,
	.clk_flags = CLK_SET_RATE_NO_REPARENT | CLK_GET_RATE_NOCACHE | CLK_SET_RATE_GATE,
};
static sf_clk_data_t sf21h8898_pll_data_cmn = {
	.lock = &cm_pll_lock,
	.clk_flags = CLK_SET_RATE_NO_REPARENT | CLK_GET_RATE_NOCACHE | CLK_IGNORE_UNUSED,
};

static const struct of_device_id sf21h8898_cfg_of_match[] = {
	{
		.compatible = "siflower,sf21h8898-cmn-pll",
		.data = &sf21h8898_pll_data_cmn,
	},
	{
		.compatible = "siflower,sf21h8898-ddr-pll",
		.data = &sf21h8898_pll_data_ddr,
	},
	{
		.compatible = "siflower,sf21h8898-eth-pll",
		.data = &sf21h8898_pll_data_eth,
	},
	{
		.compatible = "siflower,sf21h8898-pcie-pll",
		.data = &sf21h8898_pll_data_pcie,
	},
	{
		.compatible = "siflower,sf21h8898-cpu-clk",
		.data = &sf21h8898_clk_data_cpu,
	},
	{
		.compatible = "siflower,sf21h8898-realcpu-clk",
		.data = &sf21h8898_clk_data_realcpu,
	},
	{
		.compatible = "siflower,sf21h8898-gic-clk",
		.data = &sf21h8898_clk_data_on,
	},
	{
		.compatible = "siflower,sf21h8898-axi-clk",
		.data = &sf21h8898_clk_data_on,
	},
	{
		.compatible = "siflower,sf21h8898-ahb-clk",
		.data = &sf21h8898_clk_data_on,
	},
	{
		.compatible = "siflower,sf21h8898-apb-clk",
		.data = &sf21h8898_clk_data_on,
	},
	{
		.compatible = "siflower,sf21h8898-serdescsr-clk",
		.data = &sf21h8898_clk_data_on,
	},
	{
		.compatible = "siflower,sf21h8898-iram-clk",
		.data = &sf21h8898_clk_data_on,
	},
	{
		.compatible = "siflower,sf21h8898-irom-clk",
		.data = &sf21h8898_clk_data_on,
	},
	{
		.compatible = "siflower,sf21h8898-npu-clk",
		.data = &sf21h8898_clk_data,
	},
	{
		.compatible = "siflower,sf21h8898-ddrphyref-clk",
		.data = &sf21h8898_clk_data_on,
	},
	{
		.compatible = "siflower,sf21h8898-ddrbyp-clk",
		.data = &sf21h8898_clk_data_on,
	},
	{
		.compatible = "siflower,sf21h8898-ethphyrefp-clk",
		.data = &sf21h8898_clk_data,
	},
	{
		.compatible = "siflower,sf21h8898-ethphyrefn-clk",
		.data = &sf21h8898_clk_data,
	},
	{
		.compatible = "siflower,sf21h8898-ethtsu-clk",
		.data = &sf21h8898_clk_data,
	},
	{
		.compatible = "siflower,sf21h8898-gmacbypref-clk",
		.data = &sf21h8898_clk_data,
	},
	{
		.compatible = "siflower,sf21h8898-pcierefp-clk",
		.data = &sf21h8898_clk_data,
	},
	{
		.compatible = "siflower,sf21h8898-pcierefn-clk",
		.data = &sf21h8898_clk_data,
	},
	{
		.compatible = "siflower,sf21h8898-uartext-clk",
		.data = &sf21h8898_clk_data_on,
	},
	{
		.compatible = "siflower,sf21h8898-usbphyref-clk",
		.data = &sf21h8898_clk_data,
	},
	{
		.compatible = "siflower,sf21h8898-usbbus-clk",
		.data = &sf21h8898_clk_data,
	},
	{
		.compatible = "siflower,sf21h8898-usbsus-clk",
		.data = &sf21h8898_clk_data,
	},
	{
		.compatible = "siflower,sf21h8898-pbus-clk",
		.data = &sf21h8898_clk_data,
	},
	{
		.compatible = "siflower,sf21h8898-cryptcsr-clk",
		.data = &sf21h8898_clk_data,
	},
	{
		.compatible = "siflower,sf21h8898-cryptapp-clk",
		.data = &sf21h8898_clk_data,
	},
	{}
};
...
{
	return of_match_node(&sf21h8898_cfg_of_match[index], np);
}
...
static void __init sf21h8898_pbus_setup(struct device_node *np)
{
	unsigned char num_parents;
...
static void __init sf21h8898_cfg_setup(struct device_node *np, int cfg_type)
{
...
static void __init sf21h8898_pll_setup(struct device_node *np, int pll_type)
{
	struct clk *clk;
...
#define SF_CLK_DECLARE(name, compat, type)                              \
	static void __init sf21h8898_##name##_setup(struct device_node *np) \
	{                                                                   \
		sf21h8898_cfg_setup(np, type);                                  \
		return;                                                         \
	}                                                                   \
	CLK_OF_DECLARE(name, compat, sf21h8898_##name##_setup)

#define SF_PLL_DECLARE(name, compat, type)                              \
	static void __init sf21h8898_##name##_setup(struct device_node *np) \
	{                                                                   \
		sf21h8898_pll_setup(np, type);                                  \
		return;                                                         \
	}                                                                   \
	CLK_OF_DECLARE(name, compat, sf21h8898_##name##_setup)

CLK_OF_DECLARE(sf21h8898_pbus_clk, "siflower,sf21h8898-pbus-clk", sf21h8898_pbus_setup);
SF_CLK_DECLARE(sf21h8898_cpu_clk, "siflower,sf21h8898-cpu-clk", CPU_CFG);
SF_CLK_DECLARE(sf21h8898_realcpu_clk, "siflower,sf21h8898-realcpu-clk", REALCPU_CFG);
SF_CLK_DECLARE(sf21h8898_gic_clk, "siflower,sf21h8898-gic-clk", GIC_CFG);
SF_CLK_DECLARE(sf21h8898_axi_clk, "siflower,sf21h8898-axi-clk", AXI_CFG);
SF_CLK_DECLARE(sf21h8898_ahb_clk, "siflower,sf21h8898-ahb-clk", AHB_CFG);
SF_CLK_DECLARE(sf21h8898_apb_clk, "siflower,sf21h8898-apb-clk", APB_CFG);
SF_CLK_DECLARE(sf21h8898_serdescsr_clk, "siflower,sf21h8898-serdescsr-clk", SERDES_CSR_CFG);
SF_CLK_DECLARE(sf21h8898_iram_clk, "siflower,sf21h8898-iram-clk", IRAM_CFG);
SF_CLK_DECLARE(sf21h8898_irom_clk, "siflower,sf21h8898-irom-clk", IROM_CFG);
SF_CLK_DECLARE(sf21h8898_ethrefclkp_clk, "siflower,sf21h8898-ethphyrefp-clk", ETH_PHY_REF_CFG_P);
SF_CLK_DECLARE(sf21h8898_cryptcsr_clk, "siflower,sf21h8898-cryptcsr-clk", CRYPTCSR_CFG);
SF_CLK_DECLARE(sf21h8898_cryptapp_clk, "siflower,sf21h8898-cryptapp-clk", CRYPTAPP_CFG);
SF_CLK_DECLARE(sf21h8898_npu_clk, "siflower,sf21h8898-npu-clk", NPU_CFG);
SF_CLK_DECLARE(sf21h8898_ddrphyref_clk, "siflower,sf21h8898-ddrphyref-clk", DDR_PHY_CFG);
SF_CLK_DECLARE(sf21h8898_ddrbyp_clk, "siflower,sf21h8898-ddrbyp-clk", DDR_BYP_CFG);
SF_CLK_DECLARE(sf21h8898_ethtsu_clk, "siflower,sf21h8898-ethtsu-clk", ETH_TSU_CFG);
SF_CLK_DECLARE(sf21h8898_gmacbypref_clk, "siflower,sf21h8898-gmacbypref-clk", GMAC_BYP_REF_CFG);
SF_CLK_DECLARE(sf21h8898_pcierefp_clk, "siflower,sf21h8898-pcierefp-clk", PCIE_REF_CFG_P);
SF_CLK_DECLARE(sf21h8898_pcierefn_clk, "siflower,sf21h8898-pcierefn-clk", PCIE_REF_CFG_N);
SF_CLK_DECLARE(sf21h8898_uartext_clk, "siflower,sf21h8898-uartext-clk", UART_EXT_CFG);
SF_PLL_DECLARE(sf21h8898_cmn_pll, "siflower,sf21h8898-cmn-pll", CMN_PLL);
SF_PLL_DECLARE(sf21h8898_ddr_pll, "siflower,sf21h8898-ddr-pll", DDR_PLL);
SF_PLL_DECLARE(sf21h8898_pcie_pll, "siflower,sf21h8898-pcie-pll", PCIE_PLL);
