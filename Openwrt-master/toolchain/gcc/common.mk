...
ifeq ($(PKG_VERSION),10.4.0-thead2.10.2)
  PKG_VERSION:=10.4.0-thead2.10.2
  PKG_SOURCE_URL:=https://github.com/XUANTIE-RV/gcc/archive/f5a9b6323dfca0a3aa49ea67e58a21df14a8b81a.tar.gz?
  PKG_SOURCE:=$(PKG_NAME)-$(PKG_VERSION).tar.gz
  PKG_HASH:=skip
  TAR_OPTIONS += --transform s/gcc-f5a9b6323dfca0a3aa49ea67e58a21df14a8b81a/gcc-10.4.0-thead2.10.2/
endif
...
ifeq ($(PKG_VERSION),14.1.1-xuantie-3.0.1)
  PKG_VERSION:=14.1.1-xuantie-3.0.1
  PKG_SOURCE_VERSION:=c2e0bcc86d1f6eb59051cba8efdcca165fa3e858
  PKG_SOURCE_URL:=https://codeload.github.com/XUANTIE-RV/gcc/tar.gz/$(PKG_SOURCE_VERSION)?
  PKG_SOURCE:=$(PKG_NAME)-$(PKG_VERSION).tar.gz
  PKG_HASH:=e04586eb3d2578fbf37304bd7311d19812a0557e79ef85de5a92df840e22e16f
  TAR_OPTIONS += --transform s/gcc-$(PKG_SOURCE_VERSION)/gcc-$(PKG_VERSION)/
endif
