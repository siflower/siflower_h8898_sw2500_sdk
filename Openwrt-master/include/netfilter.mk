...
$(eval $(if $(NF_KMOD),$(call nf_add,NFT_NAT,CONFIG_NFT_REDIR, $(P_XT)nft_redir),))
...
$(eval $(if $(NF_KMOD),$(call nf_add,NFT_HASH,CONFIG_NFT_HASH, $(P_XT)nft_hash),))
$(eval $(if $(NF_KMOD),$(call nf_add,NFT_NUMGEN,CONFIG_NFT_NUMGEN, $(P_XT)nft_numgen),))
$(eval $(if $(NF_KMOD),$(call nf_add,NFT_OBJREF,CONFIG_NFT_OBJREF, $(P_XT)nft_objref),))
$(eval $(if $(NF_KMOD),$(call nf_add,NFT_QUOTA,CONFIG_NFT_QUOTA, $(P_XT)nft_quota),))
