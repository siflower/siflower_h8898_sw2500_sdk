L.ui.view.extend({
    ...
    execute: function() {
        ...
        var m = new L.cbi.Map('basic_setting', {
            ...
            description: L.tr('DMZ is a buffer between the internal and external networks that isolates direct connections between external access and the internal network. By placing devices that provide external services (such as web servers, mail servers, FTP servers, etc.) in the DMZ area, even if these devices are attacked, they will not directly affect the internal network system of the enterprise.'),
            collabsible: true
        });
