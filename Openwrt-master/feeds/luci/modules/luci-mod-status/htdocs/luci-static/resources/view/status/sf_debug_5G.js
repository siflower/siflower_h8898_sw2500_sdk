		...
		return uci.load('uhttpd').then(function() {
			...
			if ( '0' === debug_disabled ){
				return Promise.all([
					...
					fs.trimmed('/sys/kernel/debug/ieee80211/phy0/siwifi/txq'),
					fs.trimmed('/sys/kernel/debug/ieee80211/phy0/siwifi/hwq'),
					fs.trimmed('/sys/kernel/debug/ieee80211/phy0/siwifi/stats'),
					fs.trimmed('/sys/kernel/debug/ieee80211/phy0/siwifi/lmactx'),
					fs.trimmed('/sys/kernel/debug/ieee80211/phy0/siwifi/lmacrx'),
